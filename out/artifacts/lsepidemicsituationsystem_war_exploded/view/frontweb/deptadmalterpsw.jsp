...
<head>
    ...
    <script type="text/javascript">
        function toback() {
            location.href = "${pageContext.request.contextPath}/view/deptadmin/deptmainview.jsp"
        }
    </script>
</head>
<body>
     <div class="core col-md-4" >
         ...
         <form action="${pageContext.request.contextPath}/DeptAdmAlterPswServlet" method="post">
