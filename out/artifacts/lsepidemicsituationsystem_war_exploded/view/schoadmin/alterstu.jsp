...
<body>
    <div class="col-md-3 core">
        ...
        <form action="${pageContext.request.contextPath}/SchoAlterStuServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" required="required" class="form-control" name="sdept" value="${student.sdept}" id="inputWorkYears" placeholder="请输入学院">
            </div>
            <div class="form-group">
