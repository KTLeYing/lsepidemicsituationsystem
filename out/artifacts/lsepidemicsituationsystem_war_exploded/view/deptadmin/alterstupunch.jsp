...
<body>
    <div class="col-md-3 core">
        <h3 align="center">修改学院学生打卡信息</h3>
        <form action="${pageContext.request.contextPath}/DeptAlterStuPunchServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" list="list3" value="${stuPunch.siscough}" class="form-control" name="siscough" id="inputcough" placeholder="请选择咳嗽情况">
                <datalist id="list3">
                    <option>是</option>
                    <option>否</option>
                </datalist>
            ...
            <div class="form-group">
                ...
                <input type="text" list="list5" value="${stuPunch.sisseem}" class="form-control" name="sisseem" id="inputseem" placeholder="请选择疑似病例情况">
                <datalist id="list5">
                    <option>是</option>
                    <option>否</option>
                </datalist>
            ...
            <div class="form-group">
                ...
                <input type="text" list="list6" value="${stuPunch.sisdiagnose}" class="form-control" name="sisdiagnose" id="inputsure" placeholder="请选择确诊病例情况">
                <datalist id="list6">
                    <option>是</option>
                    <option>否</option>
                </datalist>
