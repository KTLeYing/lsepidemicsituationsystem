...
<body>
    ...
    <div class="col-md-4 core">
        <h3 align="center" style="font-weight: bold">学院管理员登录</h3>
        <form action="${pageContext.request.contextPath}/DeptAdmLoginServlet" method="post">
            ...
            <div class="form-group">
                <label for="belong" class="control-label">身份</label>
                <input type="text" list="idList" class="form-control identity" required="required" placeholder="请选择学院管理员身份" name="belong" id="belong" >
                <datalist id="idList">
            ...
            <div class="pull-right form-group">
                <a href="${pageContext.request.contextPath}/view/frontweb/deptadmforgetpsw.jsp">忘记密码</a>
            </div>
            <br>
