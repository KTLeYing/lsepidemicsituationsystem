...
<head>
    ...
    <script type="text/javascript">
        function toback() {
            location.href = "${pageContext.request.contextPath}/view/frontweb/stulogin.jsp"
        }
    </script>
</head>
<body>
     <div class="core col-md-4" >
         ...
         <form action="${pageContext.request.contextPath}/StuForgetPswServlet" method="post">
