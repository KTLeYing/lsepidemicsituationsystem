...
<body>
      <div class="col-md-3 core">
          ...
          <br>
          <form action="${pageContext.request.contextPath}/SchoQueryStuByIdServlet1" method="post">
              <div class="form-group">
                  <label for="inputSno">学号:</label>
                  <input type="text" required="required" class="form-control" name="sno" id="inputSno" placeholder="请输入要修改的学生学号">
              </div>
